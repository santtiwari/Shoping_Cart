					...
					<tbody>
						<c:forEach var="product" items="${products}">
							<tr>
								...
								<td><img
									src="<c:url value='/img/product_img/${product.image}' />"
									width="50" height="50" alt="Product Image"></td>
								<td>${product.title}</td>
								...
								<td><a
									...
									class="btn btn-outline-danger"><i
										class="fa-solid fa-eraser"></i>Delete</a></td>
						...
						<nav aria-label="Page navigation example">
							<ul class="pagination">
								<li class="page-item ${isFirst ? 'disabled' : ''}"><a
									class="page-link"
									href="${pageContext.request.contextPath}/admin/products?pageNo=${pageNo - 1}"
								...
								<c:forEach var="i" begin="1" end="${totalPages}">
									<li class="page-item ${i == (pageNo + 1) ? 'active' : ''}">
										<a class="page-link"
										href="${pageContext.request.contextPath}/admin/products?pageNo=${i - 1}">${i}</a>
									</li>
								</c:forEach>
