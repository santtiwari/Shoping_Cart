...
<table class="table">
  ...
  <c:forEach var="user" items="${users}">
    <tr>
      ...
      <td>${user.isEnable}</td>
      <td>
      <a href="<c:url value='/admin/updateSts?status=true&id=${user.id}' />" 
      class="btn btn-outline-primary">
      <i class="fa-solid fa-pen-to-square"></i>Active</a>
      
      <a href="<c:url value='/admin/updateSts?status=false&id=${user.id}' />" 
